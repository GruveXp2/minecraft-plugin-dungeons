...
public enum Room {
    ...
    FORTRESS_BRIDGE_BOW_END_1(new RoomStructure("fortress", "bridge/bow_end_1", RoomType.FORTRESS_BRIDGE), GrowRate.END),
    FORTRESS_BRIDGE_BOW_END_2(new DamagedRoomStructure("fortress", "bridge/bow_end_2", RoomType.FORTRESS_BRIDGE), GrowRate.END),
