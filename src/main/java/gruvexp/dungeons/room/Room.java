...
public enum Room {
    ...
    FORTRESS_BRIDGE_F(new RoomStructure("fortress", "bridge/f", RoomType.FORTRESS_BRIDGE), GrowRate.STATIC),
    FORTRESS_BRIDGE_L(new RoomStructure("fortress", "bridge/l", RoomType.FORTRESS_BRIDGE), GrowRate.STATIC),
    FORTRESS_BRIDGE_R(new RoomStructure("fortress", "bridge/r", RoomType.FORTRESS_BRIDGE), GrowRate.STATIC),
    FORTRESS_BRIDGE_X(new RoomStructure("fortress", "bridge/x", RoomType.FORTRESS_BRIDGE), GrowRate.EXPANDING),
