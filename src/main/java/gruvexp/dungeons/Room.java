...
public enum Room {
    ...
    FORTRESS_BRIDGE_BOW_X(new DungeonStructure("fortress", "bridge/bow_x", new Coord(10, 6, 0), RoomType.FORTRESS_BRIDGE), GrowRate.EXPANDING),
    FORTRESS_BRIDGE_X(new DungeonStructure("fortress", "bridge/x", new Coord(3, 1, 0), RoomType.FORTRESS_BRIDGE), GrowRate.EXPANDING),
