...
public enum Room {
    // dungeon
    END(new DungeonStructure("dungeon", "end", new Coord(2, 1, 0)), GrowRate.SHRINKING, RoomType.CATACOMB_WALKWAY),
    STRAIGHT(new DungeonStructure("dungeon", "straight", new Coord(2, 1, 0)), GrowRate.STATIC, RoomType.CATACOMB_WALKWAY),
    SKELETON_TRAP(new DungeonStructure("dungeon", "skeleton_trap", new Coord(3, 1, 0)), GrowRate.STATIC, RoomType.CATACOMB_WALKWAY), // +1x pga må ha en blokk for å henge tripwire hook på
    ARROW_TRAP(new DungeonStructure("dungeon", "arrow_trap", new Coord(3, 1, 0)), GrowRate.STATIC, RoomType.CATACOMB_WALKWAY),
    TURN_R(new DungeonStructure("dungeon", "turn_r", new Coord(2, 1, 0)), GrowRate.STATIC, RoomType.CATACOMB_WALKWAY),
    TURN_L(new DungeonStructure("dungeon", "turn_l", new Coord(2, 1, 0)), GrowRate.STATIC, RoomType.CATACOMB_WALKWAY),
    T_SPLIT_R(new DungeonStructure("dungeon", "t_split_r", new Coord(2, 1, 0)), GrowRate.EXPANDING, RoomType.CATACOMB_WALKWAY),
    T_SPLIT_M(new DungeonStructure("dungeon", "t_split_m", new Coord(2, 1, 0)), GrowRate.EXPANDING, RoomType.CATACOMB_WALKWAY),
