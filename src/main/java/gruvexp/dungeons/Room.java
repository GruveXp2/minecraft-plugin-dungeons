...
public enum Room {
    // dungeon
    END(new DungeonStructure("dungeon", "end", new Coord(2, 1, 0), RoomType.CATACOMB_WALKWAY), GrowRate.SHRINKING),
    ...
    FORTRESS_BRIDGE_BLAZE(new DungeonStructure("fortress", "bridge/blaze", new Coord(3, 3, 0), RoomType.FORTRESS_BRIDGE), GrowRate.STATIC),
